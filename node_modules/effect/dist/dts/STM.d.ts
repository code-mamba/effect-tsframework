 ...
 * @category constructors
 */
export declare const gen: <Eff extends STM<any, any, any>, AEff>(f: (resume: Adapter) => Generator<Eff, AEff, never>) => STM<AEff, [
    Eff
] extends [never] ? never : [Eff] extends [STM<infer _A, infer E, infer _R>] ? E : never, [
    Eff
] extends [never] ? never : [Eff] extends [STM<infer _A, infer _E, infer R>] ? R : never>;
/**
